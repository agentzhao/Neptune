...
$query= $con->prepare("UPDATE inventory SET ptitle='$pname', pprice='$pprice', pquantity='$pquantity', pdescription='$pdescription', pdates='$pdates',pimagepath='$pimagepath', pduration='$pduration', planguage='$planguage', pvenue='$pvenue' WHERE product_id='$pcode'");

if ($query->execute()){

  
  echo "<script type='text/javascript'>alert('Product details updated!');window.location.href = 'listview.php';</script>";
}else{

  echo "<script type='text/javascript'>alert('Error with updating product. Check your input again.');window.location.href = 'listview.php';</script>";
}
}
